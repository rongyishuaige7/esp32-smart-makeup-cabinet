...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical cabinet prototype photo. |
| `assets/screenshots/historical-interface-overview.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical interface capture. |
| `assets/screenshots/historical-interface-storage.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical interface capture. |
| `assets/screenshots/historical-interface-environment.jpg` | 2026-04-08 | EXIF/GPS and other image metadata removed; resized from a copy | Historical interface capture. |
